...
class ImageView extends PureComponent {
  ...
  render() {
    ...
    return (
      <div className="imageview">
        ...
        {disablePageNum ? null : (
          <div className="page" ref={this.refPage}>
  ...
  onPinch = (evt) => {
    ...
    this.ob.translateX =
      this.ob.translateX + (originX2 - originX) * this.ob.scaleX;
    this.ob.translateY =
      this.ob.translateY + (originY2 - originY) * this.ob.scaleY;
  ...
  onDoubleTap = (evt) => {
    ...
    if (this.ob.scaleX === 1) {
      ...
      this.setScale(
        isLongPic ? this.screenWidth / this.ob.width : this.props.maxScale
      );
    } else {
